...
/* package Regression-0.1.0.0 */
#define VERSION_Regression "0.1.0.0"
#define MIN_VERSION_Regression(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "Regression-0.1.0.0-Hh1pRP1rCkUnyvhsfaBff"

#define CURRENT_PACKAGE_KEY "Regression-0.1.0.0-Hh1pRP1rCkUnyvhsfaBff"
